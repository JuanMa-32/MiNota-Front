...
export const AlumnosListPage = () => {
    ...
    const { idDivision,page } = useParams();
    ...
    return (
        <>
            {!visibleBuscar ||
                <ModalBuscarAlumno idDivision={idDivision} page={page}/>}
            <Link className='btn btn-sm' style={{ background: '#445cff', color: 'white' }} to={`/division/mover_alumnos/${idDivision}`}>Mover entre divisiones</Link>
