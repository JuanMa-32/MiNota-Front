      ...
      <form className="needs-validation" onSubmit={onSubmit}>
        ...
        <div className="row g-3">
          <div className="col-sm-2">
            ...
            <input  type="number" className="form-control form-control-sm" id="lastName" name="cuil" onChange={onInputChange} value={alumnoForm.cuil} />
          </div>
          <div className="col-sm-2">
          ...
          <div className="col-md-2">
            ...
            <select className="form-select form-select-sm" name="genero" value={alumnoForm.genero} onChange={onInputChange}>
          ...
          <div className="col-md-3">
            ...
            <select className="form-select form-select-sm" name="nacionalidad" value={alumnoForm.nacionalidad} onChange={onInputChange}>
              <option value="" disabled selected>Seleccionar</option>
          ...
          {activeTab === 'DATOS DOMICILIO' && (
            <div className="row g-3">
              ...
              <div className="col-sm-1">
                ...
                <input type="text" className="form-control form-control-sm" name="piso" value={alumnoForm.piso} onChange={onInputChange} />
              </div>
          ...
          {activeTab === 'DATOS PERSONALES' && (
            <div className="row g-3">
              <div className="col-md-3">
                ...
                <select className="form-select form-select-sm" name="nivelEstudio" value={alumnoForm.nivelEstudio} onChange={onInputChange} >
                  <option value="" disabled selected>Seleccionar</option>
              ...
              <div className="col-md-3">
                ...
                <select className="form-select form-select-sm" name="ocupacion" onChange={onInputChange} value={alumnoForm.ocupacion} >
                  <option value="" disabled selected>Seleccionar</option>
              ...
              <div className="col-md-3">
                ...
                <select className="form-select form-select-sm" name="prestadora" onChange={onInputChange} value={alumnoForm.prestadora}  >
                  <option value="" disabled selected>Seleccionar</option>
              ...
              <div className="col-md-3">
                ...
                <select className="form-select form-select-sm" name="estadoCivil" onChange={onInputChange} value={alumnoForm.estadoCivil} >
                  <option value="" disabled selected>Seleccionar</option>
              ...
              <div className="col-md-3">
                ...
                <select className="form-select form-select-sm" name="obraSocial" onChange={onInputChange} value={alumnoForm.obraSocial}>
                  <option value="" disabled selected>Seleccionar</option>
              ...
              <div className="col-md-3">
                ...
                <select className="form-select form-select-sm" name="grupoSanguineo" onChange={onInputChange} value={alumnoForm.grupoSanguineo}>
                  <option value="" disabled selected>Seleccionar</option>
              ...
              <div className="col-sm-12">
                ...
                <input type="text" className="form-control form-control-sm" id="lastName" placeholder="" name="observacion" onChange={onInputChange} value={alumnoForm.obvservacionesd} />
              </div>
            </div>
          )}
        </div>
